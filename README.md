...
> **网易云模块兼容性：** `163-music` 从 1.1.0-beta1 起仅提供单一 Modern API APK，要求 LSPosed Modern API 101 或更高版本；仅支持 Legacy API 的 LSPosed 1.9.2 无法加载该模块。其余提供者模块仍使用 Legacy API，不受此变更影响。
